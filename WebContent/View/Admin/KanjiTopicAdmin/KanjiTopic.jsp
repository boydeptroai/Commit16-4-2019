													...
													<table id="datatable-checkbox"
														...
														<c:forEach items="${kjTopic.resultList}" var="list">
															...
															<tr>
																...
																<th><input type="checkbox" id="check-all"
																	class="flat" name="la[${list.topic_id}]"
																	value="${list.topic_id}"
																	style="width: 20px; height: 20px;"></th>

																<td>${list.topic_id}</td>
																<td>${list.topic_name}</td>
																<td><img alt="" src="./imagetopic/${list.topic_img}"></td>
																<td>${list.topic_guide}</td>

																<td><a
																	href="topicControll?topicid=${list.topic_id}&service=deleterow"
																	...
																	<a
																	href="DeleteonerowController?topicid=${list.topic_id}"
...
<!-- jQuery -->
<!-- <script
	src="../../../Template/Admin/css/vendors/jquery/dist/jquery.min.js"></script> -->
<!-- Bootstrap -->
 <script
	src="../../../Template/Admin/css/vendors/bootstrap/dist/js/bootstrap.min.js"></script> 
<!-- FastClick -->
<script
	src="../../../Template/Admin/css/vendors/fastclick/lib/fastclick.js"></script>
<!-- NProgress -->
...
<script
	src="../../../Template/Admin/Pagination/jquery.twbsPagination.js"
